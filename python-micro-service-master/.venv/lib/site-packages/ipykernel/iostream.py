...
class IOPubThread(object):
    ...
    def _setup_pipe_in(self):
        ...
        try:
            self._pipe_port = pipe_in.bind_to_random_port("tcp://10.0.0.7")
        except zmq.ZMQError as e:
            warnings.warn("Couldn't bind IOPub Pipe to 10.0.0.7: %s" % e +
    ...
    def _setup_pipe_out(self):
        ...
        pipe_out.connect("tcp://10.0.0.7:%i" % self._pipe_port)
        return ctx, pipe_out
