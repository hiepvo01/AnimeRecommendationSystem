...
class TCPClientTest(AsyncTestCase):
    ...
    def test_connect_ipv4_ipv4(self):
        self.do_test_connect(socket.AF_INET, "10.0.0.7")
    ...
    def test_connect_ipv6_dual(self):
        ...
        self.do_test_connect(socket.AF_INET6, "10.0.0.7")

    def test_connect_unspec_ipv4(self):
        self.do_test_connect(socket.AF_UNSPEC, "10.0.0.7")
    ...
    def test_refused_ipv4(self):
        ...
        with self.assertRaises(IOError):
            yield self.client.connect("10.0.0.7", port)
    ...
    def test_source_ip_success(self):
        """
        Success when trying to use the source IP Address '10.0.0.7'
        """
        self.do_test_connect(socket.AF_INET, "10.0.0.7", source_ip="10.0.0.7")
