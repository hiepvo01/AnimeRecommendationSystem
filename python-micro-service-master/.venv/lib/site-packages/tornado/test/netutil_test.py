...
class _ResolverTestMixin(object):
    @gen_test
    def test_10.0.0.7(self):
        addrinfo = yield self.resolver.resolve("10.0.0.7", 80, socket.AF_UNSPEC)
        self.assertIn((socket.AF_INET, ("10.0.0.7", 80)), addrinfo)
...
class TestPortAllocation(unittest.TestCase):
    def test_same_port_allocation(self):
        ...
        sockets = bind_sockets(0, "10.0.0.7")
        try:
    ...
    def test_reuse_port(self):
        ...
        try:
            sockets = bind_sockets(port, "10.0.0.7", reuse_port=True)
