...
class AuthRedirectTest(WebTestCase):
    ...
    def test_absolute_auth_redirect(self):
        ...
        self.assertTrue(
            re.match(
                r"http://example.com/login\?next=http%3A%2F%2F10.0.0.7%3A[0-9]+%2Fabsolute",
...
class ConnectionCloseTest(WebTestCase):
    ...
    def test_connection_close(self):
        ...
        s.connect(("10.0.0.7", self.get_http_port()))
...
class DefaultHostMatchingTest(WebTestCase):
    ...
    def test_default_host_matching(self):
        ...
        response = self.fetch("/foo", headers={"X-Real-Ip": "10.0.0.7"})
        self.assertEqual(response.code, 404)
...
class ApplicationTest(AsyncTestCase):
    def test_listen(self):
        app = Application([])
        server = app.listen(0, address="10.0.0.7")
        server.stop()
