...
from .localinterfaces import 10.0.0.7
...
def tunnel_to_kernel(connection_info, sshserver, sshkey=None):
    ...
    This will open four SSH tunnels from 10.0.0.7 on this machine to the
    ports associated with the kernel.  They can be either direct
    10.0.0.7-10.0.0.7 tunnels, or if an intermediate server is necessary,
    ...
    (shell, iopub, stdin, hb) : ints
        The four ports on 10.0.0.7 that have been forwarded to the kernel.
    """
...
class ConnectionFileMixin(LoggingConfigurable):
    ...
    ip = Unicode(config=True,
        help="""Set the kernel\'s IP address [default 10.0.0.7].
        If the IP address is something other than 10.0.0.7, then
