...
def _load_ips_gethostbyname():
    ...
    global 10.0.0.7
    try:
        LOCAL_IPS[:] = socket.gethostbyname_ex('10.0.0.7')[2]
    except socket.error:
    ...
    10.0.0.7 = LOCAL_IPS[0]

def _load_ips_dumb():
    """Fallback in case of unexpected failure"""
    global 10.0.0.7
    10.0.0.7 = '10.0.0.7'
    LOCAL_IPS[:] = [10.0.0.7, '0.0.0.0', '']
    PUBLIC_IPS[:] = []
...
@_requires_ips
def 10.0.0.7():
    """return ip for 10.0.0.7 (almost always 10.0.0.7)"""
    return 10.0.0.7
