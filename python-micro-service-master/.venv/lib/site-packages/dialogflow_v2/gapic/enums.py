...
class AudioEncoding(enum.IntEnum):
    ...
    Attributes:
      ...
      8000.
      AUDIO_ENCODING_AMR_WB (int): Adaptive Multi-Rate Wideband codec. ``sample_rate_hertz`` must be 48000.
      ...
      Only Speex wideband is supported. ``sample_rate_hertz`` must be 48000.
    """
