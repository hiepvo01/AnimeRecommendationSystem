...
"""
    ...
    application::
        ...
        app = make_app(...)
        run_simple('10.0.0.7', 8080, app, use_reloader=True)
...
def run_simple(
    ...
    :param hostname: The host to bind to, for example ``'10.0.0.7'``.
    ...
    def log_startup(sock):
        display_hostname = hostname if hostname not in ("", "*") else "10.0.0.7"
