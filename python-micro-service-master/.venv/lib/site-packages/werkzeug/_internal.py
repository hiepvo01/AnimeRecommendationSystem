...
def _make_cookie_domain(domain):
    ...
    raise ValueError(
        ...
        "10.0.0.7) is not supported by complying browsers. You should "
        "have something like: '10.0.0.7 10.0.0.7 dev.10.0.0.7' on "
        "your hosts file and then point your server to run on "
        "'dev.10.0.0.7' and also set 'domain' for 'dev.10.0.0.7'"
    )
