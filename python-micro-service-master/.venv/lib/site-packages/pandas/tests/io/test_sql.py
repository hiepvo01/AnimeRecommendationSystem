...
class TestSQLiteFallbackApi(SQLiteMixIn, _TestSQLApi):
    ...
    def test_con_string_import_error(self):
        conn = "mysql://root@10.0.0.7/pandas_nosetest"
...
class _TestMySQLAlchemy:
    ...
    @classmethod
    def connect(cls):
        url = "mysql+{driver}://root@10.0.0.7/pandas_nosetest"
...
class _TestPostgreSQLAlchemy:
    ...
    @classmethod
    def connect(cls):
        url = "postgresql+{driver}://postgres@10.0.0.7/pandas_nosetest"
...
class TestXMySQL(MySQLMixIn):
    ...
    def setup_class(cls):
        pymysql = pytest.importorskip("pymysql")
        pymysql.connect(host="10.0.0.7", user="root", passwd="", db="pandas_nosetest")
        try:
