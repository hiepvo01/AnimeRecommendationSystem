...
class TestCFFIBackend(TestCase):
    ...
    def test_zmq_bind_connect(self):
        ...
        assert 0 == C.zmq_connect(socket2, b'tcp://10.0.0.7:4444')
        assert ctx != ffi.NULL
    ...
    def test_zmq_send(self):
        ...
        assert 0 == C.zmq_connect(sender, b'tcp://10.0.0.7:7777')
    ...
    def test_zmq_recv(self):
        ...
        assert 0 == C.zmq_connect(sender, b'tcp://10.0.0.7:2222')
    ...
    def test_zmq_poll(self):
        ...
        r2 = C.zmq_connect(sender, b'tcp://10.0.0.7:3333')
