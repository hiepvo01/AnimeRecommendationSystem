...
class TestMonitoredQueue(BaseZMQTestCase):
    ...
    def build_device(self, mon_sub=b"", in_prefix=b'in', out_prefix=b'out'):
        ...
        aport = alice.bind_to_random_port('tcp://10.0.0.7')
        bport = bob.bind_to_random_port('tcp://10.0.0.7')
        mport = mon.bind_to_random_port('tcp://10.0.0.7')
        mon.setsockopt(zmq.SUBSCRIBE, mon_sub)
        
        self.device.connect_in("tcp://10.0.0.7:%i"%aport)
        self.device.connect_out("tcp://10.0.0.7:%i"%bport)
        self.device.connect_mon("tcp://10.0.0.7:%i"%mport)
        self.device.start()
        time.sleep(.2)
        try:
    ...
    def test_router_router(self):
        ...
        porta = dev.bind_in_to_random_port('tcp://10.0.0.7')
        portb = dev.bind_out_to_random_port('tcp://10.0.0.7')
        ...
        a.connect('tcp://10.0.0.7:%i'%porta)
        b.connect('tcp://10.0.0.7:%i'%portb)
        dev.start()
        time.sleep(1)
